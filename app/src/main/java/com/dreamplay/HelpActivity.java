...
import com.adapter.HelpCategoryRecycleAdapter;
...
public class HelpActivity extends AppCompatActivity implements HelpCategoryRecycleAdapter.OnItemClickList {
    ...
    public void onItemClick(int position) {
        ...
        bn.putString("iFaqcategoryId", list.get(position).get("iFaqcategoryId"));
                ...
                if (responseString != null && !responseString.equals("")) {
                    ...
                    if (generalFunc.checkDataAvail(Utils.action_str, responseString) == true) {
                        ...
                        for (int i = 0; i < obj_arr.length(); i++) {
                            ...
                            map.put("vTitle", generalFunc.getJsonValue("tTitle", obj_temp.toString()));
                            map.put("iFaqcategoryId", generalFunc.getJsonValue("iFaqcategoryId", obj_temp.toString()));
