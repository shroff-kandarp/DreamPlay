...
public class MaterialSearchView extends FrameLayout {
     ...
     */
    public static final int REQUEST_VOICE = 121;
    /**
     ...
     */
    private static int MAX_HISTORY = 40;
    /**
    ...
    private void init() {
        ...
        mAdapter = new SearchAdapter(dataList, mContext);
        ...
        mSuggestionsListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                if (mOnQueryTextListener != null) {
                    mOnQueryTextListener.onClickItem(dataList.get(i));
                }
            }
        });
    }
...
//    }
    ...
    */
     ...
     *
     * @param - The suggestion to be removed.
     *//*
    ...
    public void setSearchData(ArrayList<HashMap<String, String>> dataList) {
    ...
    public interface OnQueryTextListener {
        ...
        void onClickItem(HashMap<String, String> data);
