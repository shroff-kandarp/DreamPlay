...
/**
 * Created by Shroff on 19-Aug-17.
 */
...
public class CustomDateTimePicker implements View.OnClickListener {
    ...
    public View getDateTimePickerLayout() {
        ...
        titleTxtView = new MTextView(activity);
        ...
        titleTxtView.setText("Select Date");
        titleTxtView.setLayoutParams(title_params);
        titleTxtView.setTextSize(TypedValue.COMPLEX_UNIT_SP, 17);
        titleTxtView.setPadding(0, Utils.dipToPixels(activity, 5), 0, Utils.dipToPixels(activity, 5));
        titleTxtView.setGravity(Gravity.CENTER);
        linear_main.addView(titleTxtView);
